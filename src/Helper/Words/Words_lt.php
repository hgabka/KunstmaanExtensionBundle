...
class Words_lt extends Words
{
    ...
    var $_exponent = array(
        0 => array(''),
        3 => array('tűkstantis','tűkstančiai','tűkstančiř'),
        6 => array('milijonas','milijonai','milijonř'),
        9 => array('bilijonas','bilijonai','bilijonř'),
        12 => array('trilijonas','trilijonai','trilijonř'),
        15 => array('kvadrilijonas','kvadrilijonai','kvadrilijonř'),
        18 => array('kvintilijonas','kvintilijonai','kvintilijonř')
    );
